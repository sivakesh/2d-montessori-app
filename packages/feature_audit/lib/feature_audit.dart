/// Audit & Operations
///
/// Append-only activity log covering sign-ins, workflow, role and system-setting changes.
///
/// Traceability: SRS CMS-15; NFR-07 (Auditability)
///
...
const String featureModuleName = 'feature_audit';
