...
import 'package:montessori_app/modules/auth/data/prod_phone_auth_service.dart';
...
final prodPhoneAuthServiceProvider =
    Provider<ProdPhoneAuthService>((ref) => ProdPhoneAuthService());
